...
namespace Fractal2D
{
    ...
    public class Controller
    {
            ...
            win.KeyUp += (s, e) =>
            {
                ...
                switch ((HotKeys)e.KeyCode)
                {
                    ...
                    case HotKeys.ChangeWindowMode:
                        ...
                        break;
                    case HotKeys.ParamUp:
                    case HotKeys.ParamUp2:
                        ParamUp?.Invoke();
                        break;
                    case HotKeys.ParamDown:
                    case HotKeys.ParamDown2:
                        ParamDown?.Invoke();
                        break;
                    case HotKeys.SpfUp:
        ...
        enum HotKeys: int
        {
            ...
            Exit = Keys.Escape,
            ParamUp = Keys.NumPad7,
            ParamUp2 = Keys.Home,
            ParamDown = Keys.NumPad1,
            ParamDown2 = Keys.End,
            SpfUp = Keys.NumPad9,
        ...
        /// Общие события
        /// </summary>
        public delegate void ComplexDynamicMapEventHandler();

        /// <summary>
        /// Очистка всех клеток
        /// </summary>
        public event ComplexDynamicMapEventHandler Clear;
        /// <summary>
        /// Запустить/остановить воспроизведение
        /// </summary>
        public event ComplexDynamicMapEventHandler StopPlay;
        /// <summary>
        /// Увеличить коэффициент функции
        /// </summary>
        public event ComplexDynamicMapEventHandler ParamUp;
        /// <summary>
        /// Уменьшить коэффициент функции
        /// </summary>
        public event ComplexDynamicMapEventHandler ParamDown;
        /// <summary>
        /// Увеличить количество этапов за один фрейм
        /// </summary>
        public event ComplexDynamicMapEventHandler StagesByFrameUp;
        /// <summary>
        /// Уменьшить количество этапов за один фрейм
        /// </summary>
        public event ComplexDynamicMapEventHandler StagesByFrameDown;
        /// <summary>
        /// Показать/скрыть статистику
        /// </summary>
        public event ComplexDynamicMapEventHandler StatisticModeChange;
        /// <summary>
        /// Изменение оконного режима полноэкранный-стандартный
        /// </summary>
        public event ComplexDynamicMapEventHandler WindowModeChanged;
        /// <summary>
        /// Выйти из программы
        /// </summary>
        public event ComplexDynamicMapEventHandler Exit;
